...
$gToolbars['contacts'] = array('contacts' => array('label' => $gLocale->getStr('contacts.toolbar'), 'themeimage' => 'view_icon', 'horiz' => 'true', 'action' => WuiEventsCall::buildEventsCallString('', array(array('view', 'contacts', '')))), 'newcontact' => array('label' => $gLocale->getStr('newcontact.toolbar'), 'themeimage' => 'filenew', 'horiz' => 'true', 'action' => WuiEventsCall::buildEventsCallString('', array(array('view', 'newcontact', '')))));
...
function contacts_tab_action_builder($tab) {
    return WuiEventsCall::buildEventsCallString('', array(array('view', 'contacts', array('tabpage' => $tab))));
}

$gMain_disp->addEvent('contacts', 'main_contacts');
          ...
          <children>
            ...
            <button><name>apply</name>
              <args>
                ...
                <horiz>true</horiz>
                <frame>false</frame>
                <action type="encoded">'.urlencode(WuiEventsCall::buildEventsCallString('', array(array('view', 'contacts', array('tabpage' => $tab_page))))).'</action>
                <label type="encoded">'.urlencode($gLocale->getStr('close.button')).'</label>
              </args>
            </button>
            ...
            <button><name>remove</name>
              <args>
                ...
                <action type="encoded">'.urlencode(WuiEventsCall::buildEventsCallString('', array(array('view', 'contacts', array('tabpage' => $tab_page)), array('action', 'removecontact', array('id' => $eventData['id']))))).'</action>
                </args>
              </button>
