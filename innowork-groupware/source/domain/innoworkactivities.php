...
$gLocale = new LocaleCatalog('innowork-groupware::activity_main', \Innomatic\Core\InnomaticContainer::instance('\Innomatic\Core\InnomaticContainer')->getCurrentUser()->getLanguage());
